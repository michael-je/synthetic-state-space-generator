...
def test_connect_4(seed: int=0):
    ...
    state = State(seed = 1, max_depth=md, retain_tree = True, branching_function = branching_function_connect_four, transposition_space_function=transposition_space_function_connect_four)
    state.draw_tree()
